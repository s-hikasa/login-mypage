            ...
            <form action="mypage.php" method="post">
                <div class="form_contents">
                    ...
                    <div class="mail">
                        ...
                        <input type="text" class="formbox" size="40" name="mail" value="<?php if(isset($_COOKIE['name'])){echo $_COOKIE['name'];};?>">
                    </div>
                    <div class="password">
                    ...
                    <div class="login_check">
                        <label for=""><input type="checkbox" name="login_keep" class="formbox" name="login_keep" <?php if(isset($_COOKIE['login_keep'])){echo "checked='checked'";};?>>ログイン状態を保持する</label>
                    </div>
                    <div class="login_box">
